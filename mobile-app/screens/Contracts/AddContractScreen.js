...
export default function AddContractScreen() {
  ...
  const saveContract = async () => {
    ...
    setLoading(true);
    try {
      await api.post("/api/contracts/add", {
        studentName: name,
        studentId,
        contactNumber,
        roomNumber,
      ...
      Alert.alert("Error", err.response?.data?.message || "Failed to save contract");
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerSubtitle}>Add student accommodation details</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  // 🔹 Inputs (same as student screens)
  input: {
