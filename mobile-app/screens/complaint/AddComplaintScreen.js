...
export default function AddComplaintScreen({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert("Error", err.response?.data?.message || "Failed to add complaint");
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerSubtitle}>Log a maintenance issue</Text>
          </View>
          ...
          >
            <Text style={styles.submitButtonText}>
              {loading ? "Adding Complaint..." : "Add Complaint"}
            </Text>
          </TouchableOpacity>
        </ScrollView>
      </LinearGradient>
